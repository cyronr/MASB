...
{
    public class AddDoctorToFacilityCommandHandler : IRequestHandler<AddDoctorToFacilityCommand, PagedList<DoctorDto>>
    {
        ...
        public AddDoctorToFacilityCommandHandler(
            ILogger<AddDoctorToFacilityCommandHandler> logger,
            IMapper mapper,
            IDbOperation db,
        ...
        public async Task<PagedList<DoctorDto>> Handle(AddDoctorToFacilityCommand command, CancellationToken cancellationToken)
        {
            ...
            using (var tran = _db.BeginTransaction())
            {
                try
                {
                    ...
                    _facilityRepository.CreateEvent(new FacilityEvent
                    {
                        ...
                        Facility = facility,
                        AddInfo = $"Added new doctor ({doctor.ToString()}).",
