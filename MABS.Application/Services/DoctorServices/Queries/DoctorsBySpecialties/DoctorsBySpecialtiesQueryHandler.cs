...
{
    public class DoctorsBySpecialtiesQueryHandler : IRequestHandler<DoctorsBySpecialtiesQuery, PagedList<DoctorDto>>
    {
        ...
        public async Task<PagedList<DoctorDto>> Handle(DoctorsBySpecialtiesQuery query, CancellationToken cancellationToken)
        {
