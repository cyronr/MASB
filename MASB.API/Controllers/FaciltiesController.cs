...
using MABS.Application.Services.FacilityServices.Commands.AddDoctorToFacility;
using MABS.Application.Services.FacilityServices.Commands.CreateFacility;
using MABS.Application.Services.FacilityServices.Commands.CreateFacilityAddress;
using MABS.Application.Services.FacilityServices.Commands.DeleteFacility;
using MABS.Application.Services.FacilityServices.Commands.DeleteFacilityAddress;
using MABS.Application.Services.FacilityServices.Commands.RemoveDoctorFromFacility;
using MABS.Application.Services.FacilityServices.Commands.UpdateFacility;
using MABS.Application.Services.FacilityServices.Commands.UpdateFacilityAddress;
using MABS.Application.Services.FacilityServices.Queries.GetAllCountries;
using MABS.Application.Services.FacilityServices.Queries.GetAllFacilities;
using MABS.Application.Services.FacilityServices.Queries.GetAllStreetTypes;
using MABS.Application.Services.FacilityServices.Queries.GetFacilityById;
using MABS.Application.Services.FacilityServices.Queries.GetFacilityDoctors;
